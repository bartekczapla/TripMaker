...
namespace TripMaker.Tutorial
{
    public class EventRegistrationPolicy : IEventRegistrationPolicy
    {
        ...
        private async Task CheckEventRegistrationFrequencyAsync(User user)
        {
            ...
            var maxAllowedEventRegistrationCountInLast30DaysPerUser = 5; //await _settingManager.GetSettingValueAsync<int>(AppSettingNames.MaxAllowedEventRegistrationCountInLast30DaysPerUser);
